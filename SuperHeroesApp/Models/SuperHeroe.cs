...
namespace SuperHeroesApp.Models
{
    ...
    class SuperHeroe : Heroe, ISuperHeroe
    {
        ...
        public string NombreEIdentidadSecreta { get { return $"{Nombre} ({IdentidadSecreta})"; } } //encapsulamiento
        public string IdentidadSecreta { get; set; }
        public string Ciudad;
        public List<SuperPoder> SuperPoderes; // iniciamos una variable que es una lista de super poderes
